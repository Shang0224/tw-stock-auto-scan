...
PARAM_PROFILES = {
    'TW50': {
        'name': '台灣50',
        'min_vol': 3000*1000, #單位為股, 相當於3000張
        'surge_mult': 0.8,
        # --- 動態比例門檻設定 ---
        'major_sell_ratio': 0.05,       # 主力賣超佔當日成交量 >= 5.0%
        'foreign_sell_ratio': 0.04,     # 外資賣超佔當日成交量 >= 4.0%
        'min_sell_shares': 1500*1000,   # 保底張數：權值股流動性高，至少需賣滿 1,500 張, 1,500,000股
    ...
    'MID100': {
        ...
        'min_sell_shares': 500*1000,    # 保底張數：至少 500 張 (例如神達成交 6 萬張時，自動鎖定門檻為 3,000 張)
    ...
    'ICDesign': {
        ...
        'min_sell_shares': 200*1000,    # 保底張數：高價股總張數少，200 張即具影響力
    ...
    'default': {
        ...
        'min_sell_shares': 300*1000,    # 一般個股保底 300 張
